                ...
                <tr>
                            ...
                            @if ($File['type'] == 'image')
                                <div class="rounded">
                                    <img class="img-fluid" width="25"
                                         src="{{ masterFileManagerStorage('storage/app/public/'.$File['path']) }}" alt="">
                                </div>
                    ...
                    <td class="">
                        <div class="btn-group dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="{{ masterFileManagerStorage('storage/app/public/'.$File['path']) }}" download>
